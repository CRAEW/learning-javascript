...
var colors = ['#0B4D4F', '#062829', '#1BBCC2', '#20DFE6', '#18A3A8', '#BF2A44', '#F2527C'];
...
Particle.prototype.update = function (particles) {
    ...
    if (this.x - this.radius <= 0 || this.x + this.radius >= innerWidth || this.y - this.radius <= 0 || this.y + this.radius >= innerWidth) {
        this.velocity.x = -this.velocity.x;
        this.velocity.y = -this.velocity.y;
    }

    // mouse collision detection
    if ((0, _utils.distance)(mouse.x, mouse.y, this.x, this.y) < 120 && this.opacity < 1) {
        this.opacity += 0.2;
...
module.exports = { randomIntFromRange: randomIntFromRange, randomColor: randomColor, distance: distance, resolveCollision: resolveCollision, rotate: rotate };
