...
johnRestaurant.tipCalculator();
console.log(johnRestaurant.tips);
console.log(johnRestaurant.bills);
console.log(johnRestaurant.totalPaid);
...
markHoliday.tipCalculator();
console.log(markHoliday.bills);
console.log(markHoliday.tips);
console.log(markHoliday.totalPaid);
...
markHoliday.averageTips = calcAverage(markHoliday.tips);
johnRestaurant.averageTips = calcAverage(johnRestaurant.tips);

if (markHoliday.averageTips > johnRestaurant.averageTips) {
    console.log('Average tips Mark: ' + markHoliday.averageTips);
    console.log('Average tips John: ' + johnRestaurant.averageTips);
    console.log('Mark paid more tips.');
} else if (johnRestaurant.averageTips > markHoliday.averageTips) {
    console.log('Average tips Mark: ' + markHoliday.averageTips);
    console.log('Average tips John: ' + johnRestaurant.averageTips);
